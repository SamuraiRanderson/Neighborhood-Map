...
* Filters the list view using a Knockout computed observable and the users searh input
*/
...
/* Filters the markers on the map and shows/hides them based on users search input */
